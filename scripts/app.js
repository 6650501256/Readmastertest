...
app.showSidebar();
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="home" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-image v-bind="image4"></dab-image><dab-image v-bind="image9"></dab-image><dab-image v-bind="image10"></dab-image><dab-image v-bind="image11"></dab-image><dab-image v-bind="image12"></dab-image><dab-image v-bind="image2"></dab-image><dab-image v-bind="image3"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
window.open('https://classroom.google.com/c/NzM0MTk1NzQ3ODg2?cjc=r3q5sha', '_system');
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="collaboration" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image2"></dab-image><dab-image v-bind="image4"></dab-image><dab-image v-bind="image5"></dab-image><dab-image v-bind="image6"></dab-image><dab-image v-bind="image7"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
app.showSidebar();
          ...
          image7: {
            name: "image7",
            url: "app/images/474442597_953081223597545_200553490788938629_n.png",
            classes: "",
            description: "",
            title: " Created with Unregistered DecSoft App Builder",
            imageFit: "contain",
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="coaching2" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image6"></dab-image><dab-image v-bind="image2"></dab-image><dab-image v-bind="image4"></dab-image><dab-image v-bind="image5"></dab-image><dab-image v-bind="image7"></dab-image><dab-image v-bind="image10"></dab-image><dab-image v-bind="image11"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
</dab-html><dab-image v-bind="image4"></dab-image><dab-image v-bind="image5"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image1"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
window.open('https://www.canva.com/design/DAGUI_p_vUE/t8S0Q7uSr1BE3pTSBPAPnA/view?utm_content=DAGUI_p_vUE&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=h5cd1fcabfa', '_system');
          ...
          image7: {
            name: "image7",
            url: "app/images/473827247_1263792791515955_2015559447510158482_n.png",
            classes: "",
            description: "",
            title: " Created with Unregistered DecSoft App Builder",
            imageFit: "contain",
...
window.open('https://www.canva.com/design/DAGdfosEOOw/5zXfU8m1V62lK7pUfVzo1w/view?utm_content=DAGdfosEOOw&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=h390709f3a0', '_system');
...
app.showDialog('dialogscafproce');
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="scaf1" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-image v-bind="image2"></dab-image><dab-image v-bind="image4"></dab-image><dab-image v-bind="image5"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image10"></dab-image><dab-image v-bind="image8"></dab-image><dab-image v-bind="image6"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
const scaf2 = {
 components: DabComponents,
...
app.showDialog('Ansbot11');
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="taskbot11" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-image v-bind="image4"></dab-image><dab-image v-bind="image2"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image6"></dab-image><dab-image v-bind="image7"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
app.showView('taskbot22');
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="taskbot21" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-image v-bind="image4"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image6"></dab-image><dab-image v-bind="image2"></dab-image><dab-image v-bind="image7"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
app.showView('taskbot11');
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="taskQ1" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-iframe v-bind="iframe3"></dab-iframe><dab-image v-bind="image3"></dab-image><dab-image v-bind="image4"></dab-image><dab-image v-bind="image7"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
      ...
      data() {
        return {
          ...
          iframe3: {
            name: "iframe3",
            title: " Created with Unregistered DecSoft App Builder",
            source: "https://docs.google.com/forms/d/e/1FAIpQLSfw7EBvwyahMvnxXtjGJv8qIb8BcldTSrzuFRgL02Desdnt5w/viewform?usp=header",
            classes: "",
            hidden: false,
            event: null,
            loadHandler() {}
      ...
      data() {
        return {
          ...
          iframe3: {
            name: "iframe3",
            title: " Created with Unregistered DecSoft App Builder",
            source: "https://docs.google.com/forms/d/e/1FAIpQLSfuOmgUyoLN7_PiFNB6D8CsH_EHYwJsDARdDWDw_uhMx_Jtxg/viewform?usp=header",
            classes: "",
            hidden: false,
            event: null,
            loadHandler() {}
...
app.showView('taskbot31');
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="taskQ3" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-iframe v-bind="iframe3"></dab-iframe><dab-image v-bind="image3"></dab-image><dab-image v-bind="image4"></dab-image><dab-image v-bind="image5"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
      ...
      data() {
        return {
          ...
          iframe3: {
            name: "iframe3",
            title: " Created with Unregistered DecSoft App Builder",
            source: "https://docs.google.com/forms/d/e/1FAIpQLScd24h5wLQ1VNuNR4kcWpNj-MnSfrA8587w7uKuS4yrM-gBlQ/viewform?usp=header",
            classes: "",
            hidden: false,
            event: null,
            loadHandler() {}
...
app.showView('taskbot51');
          ...
          iframe3: {
            name: "iframe3",
            title: " Created with Unregistered DecSoft App Builder",
            source: "https://docs.google.com/forms/d/e/1FAIpQLScXGEycQQ4wbbrlyRV_qWNT-DSmUp42OKg0ODqNXkI6HlqNEA/viewform?usp=header",
            classes: "",
            hidden: false,
            event: null,
            loadHandler() {}
...
app.showSidebar();
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="taskQ5" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-image v-bind="image2"></dab-image><dab-iframe v-bind="iframe3"></dab-iframe><dab-image v-bind="image3"></dab-image><dab-image v-bind="image7"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
app.showView('taskbot32');
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="taskbot31" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-image v-bind="image4"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image6"></dab-image><dab-image v-bind="image2"></dab-image><dab-image v-bind="image5"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
app.showView('taskbot44');
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="taskbot43" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-image v-bind="image4"></dab-image><dab-image v-bind="image6"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image2"></dab-image><dab-image v-bind="image5"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
app.showView('taskbot52');
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="taskbot51" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-image v-bind="image4"></dab-image><dab-image v-bind="image6"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image2"></dab-image><dab-image v-bind="image7"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
